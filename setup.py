...
version_line = open("sensirion_i2c_sps30/version.py", "rt").read()
...
setup(
    name='sensirion_i2c_sps30',
    version=version_string,
    author='Sensirion',
    author_email='info@sensirion.com',
    description='I2C driver for the Sensirion SPS30 sensor family',
    license='BSD',
    keywords="""Sensirion SPS30
        I2C
        SPS30""",
    project_urls={
        "Documentation": "https://sensirion.github.io/python-i2c-sps30",
        "Repository": "https://github.com/Sensirion/python-i2c-sps30",
        "Changelog": "https://github.com/Sensirion/python-i2c-sps30/blob/master/CHANGELOG.md",
    },
